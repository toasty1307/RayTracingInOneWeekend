...
#pragma warning disable CA1416
        ...
        var materialLeft   = new Dielectric.Dielectric(1.5f);
        ...
        var camera = new Camera(20, (float) AspectRatio, lookFrom, lookAt, Vector3.UnitY, 2.0f, (lookFrom - lookAt).Length());
